    ...
    , ui(new Ui::MainWindow)
{
    ...
    for(int i=0;ui->label_7->text()[0]!='0' || ui->label_7->text()[1]!='0' || ui->label_7->text()[2]!='0';i++)
    {
    ...
    ui->label_48->setText(ui->label_7->text());
    for(int i=0;ui->label_49->text()[0]!='0' || ui->label_49->text()[1]!='0' || ui->label_49->text()[2]!='0';i++)
    {
    ...
    ui->label_55->setText(ui->label_49->text());
    for(int i=0;ui->label_56->text()[0]!='0' || ui->label_56->text()[1]!='0' || ui->label_56->text()[2]!='0';i++)
    {
    ...
    ui->label_62->setText(ui->label_56->text());
    for(int i=0;ui->label_63->text()[0]!='0' || ui->label_63->text()[1]!='0' || ui->label_63->text()[2]!='0';i++)
    {
    ...
    ui->label_69->setText(ui->label_63->text());
    for(int i=0;ui->label_70->text()[0]!='0' || ui->label_70->text()[1]!='0' || ui->label_70->text()[2]!='0';i++)
    {
    ...
    ui->label_76->setText(ui->label_70->text());
    for(int i=0;ui->label_77->text()[0]!='0' || ui->label_77->text()[1]!='0' || ui->label_77->text()[2]!='0';i++)
    {
